...
export const oceanTheme = createTheme({
  colors: {
    ocean: [
      '#F0FDFA', // ocean[0] - lightest aqua (Ocean Light from design doc)
      '#B8E6E6', // ocean[1] - light aqua (Ocean Mist from design doc)
      '#67E8F9', // ocean[2] - medium cyan (Ocean Accent from design doc)
      '#0891B2', // ocean[3] - deep teal (Ocean Deep from design doc)
    ...
    // Mist colors for ocean effects (Ocean Mist Effects from design doc)
    mist: [
      '#F0FDFA', // mist[0] - lightest aqua (Mist Light from design doc)
      '#B8E6E6', // mist[1] - light aqua (Mist Droplet from design doc)
      '#67E8F9', // mist[2] - medium cyan (Ocean Accent from design doc)
      '#5EEAD4', // mist[3] - deep aqua
      '#2DD4BF', // mist[4] - darker aqua
      '#14B8A6', // mist[5] - darkest aqua
      '#0891B2', // mist[6] - very dark aqua (Mist Dark from design doc)
      '#0E7490', // mist[7] - ultra dark aqua
      '#155E75', // mist[8] - near black aqua
      '#164E63', // mist[9] - black aqua
    ],
    // Sakura colors (for compatibility with skill levels - mapped to ocean colors)
    sakura: [
      '#F0FDFA', // sakura[0] - lightest aqua (Ocean Light)
      '#B8E6E6', // sakura[1] - light aqua (Ocean Mist)
      '#67E8F9', // sakura[2] - medium cyan (Ocean Accent)
      '#0891B2', // sakura[3] - deep teal (Ocean Deep)
      '#0E7490', // sakura[4] - darker teal
      '#155E75', // sakura[5] - darkest teal
      '#164E63', // sakura[6] - very dark teal
      '#134E4A', // sakura[7] - ultra dark teal
      '#0F766E', // sakura[8] - near black teal
      '#0A4A42', // sakura[9] - black teal
    ],
    // Pink colors (for compatibility with skill levels - mapped to mist colors)
    pink: [
      '#F0FDFA', // pink[0] - lightest aqua (Mist Light)
      '#B8E6E6', // pink[1] - light aqua (Mist Droplet)
      '#67E8F9', // pink[2] - medium cyan (Ocean Accent)
      '#5EEAD4', // pink[3] - deep aqua
      '#2DD4BF', // pink[4] - darker aqua
      '#14B8A6', // pink[5] - darkest aqua
      '#0891B2', // pink[6] - very dark aqua (Mist Dark)
      '#0E7490', // pink[7] - ultra dark aqua
      '#155E75', // pink[8] - near black aqua
      '#164E63', // pink[9] - black aqua
    ],
  },
  primaryColor: 'ocean',
